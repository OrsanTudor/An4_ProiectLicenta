...
public class CameraShiftLevel2Script : MonoBehaviour
{
    //Variabile:
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.gameObject.CompareTag("Character") && oneTime == true)
        {
            ...
            float newCharacterPositionX = transform.position.x - 12f;
            PlayerPrefs.SetFloat("PozitieX_Checkpoint1", newCharacterPositionX);
