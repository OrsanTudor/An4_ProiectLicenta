...
public class NoGravityBlockLevel1Script5 : MonoBehaviour
{
    //Variabile:
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        if (collision.gameObject.CompareTag("Character"))
        {
            ...
            float resetValueX = 1;
            float resetValueY = 3;
            character.myRigidbody.velocity = new Vector2(
                character.myRigidbody.velocity.x / resetValueX,
                character.myRigidbody.velocity.y / resetValueY);
        }
    }
