...
public class CameraShiftLevel3Script2 : MonoBehaviour
{
    //Variabile:
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.gameObject.CompareTag("Character") && oneTime == true)
        {
            ...
            float newCheckpointPositionX = transform.position.x + 13f;
            PlayerPrefs.SetFloat("PozitieX_Checkpoint2", newCheckpointPositionX);
