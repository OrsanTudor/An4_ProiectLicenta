...
//Pentru levelul 1:
public class FinishLevelFirst : MonoBehaviour
{
    //Variabile:
    ...
    void Start()
    {
        ...
        iconNotDone = GameObject.FindGameObjectWithTag("Level1NotDone");

        iconDone = GameObject.FindGameObjectWithTag("Level1Done");
        ...
        else if (PlayerPrefs.GetInt("Level1") == 1)
        {
    ...
    private IEnumerator DisableSceneTransition(float timeLeftTransition)
    {
        ...
        PlayerPrefs.SetFloat("CharacterPositionX", 29f);
