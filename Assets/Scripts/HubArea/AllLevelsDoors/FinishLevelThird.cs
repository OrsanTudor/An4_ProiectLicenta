...
//Pentru levelul 3:
public class FinishLevelThird : MonoBehaviour
{
    //Variabile:
    ...
    void Start()
    {
        ...
        iconNotDone = GameObject.FindGameObjectWithTag("Level3NotDone");

        iconDone = GameObject.FindGameObjectWithTag("Level3Done");
        ...
        else if (PlayerPrefs.GetInt("Level3") == 1)
        {
    ...
    private IEnumerator DisableSceneTransition(float timeLeftTransition)
    {
        ...
        PlayerPrefs.SetFloat("CharacterPositionX", 466.5f);
